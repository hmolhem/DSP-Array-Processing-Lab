...
\section{Generated Figure}

The repository stores the generated figure at:

\begin{center}
\texttt{python/ex01\_fft\_spectral\_leakage/figures/fft\_spectral\_leakage.png}
\end{center}

If the figure is available relative to this LaTeX file, it is included below.
...
{
\fbox{\parbox{0.85\linewidth}{Generated figure not found. Run the Python script from the repository root to generate the FFT spectral leakage figure.}}
}
\caption{FFT spectral leakage comparison between coherent and non-coherent sinusoidal sampling.}
\label{fig:fft_leakage}
\end{figure}
