...
The repository stores two generated figures for this exercise:
...
The line-marker figure is optimized for reports, presentations, and LinkedIn carousel content. The stem figure is included to make the discrete FFT-bin interpretation more explicit.
...
If the figures are available relative to this LaTeX file, they are included below.
