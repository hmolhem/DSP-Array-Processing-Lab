...
The repository stores two generated static figures and one generated animation for this exercise:
...
If the static figures are available relative to this LaTeX file, they are included below. The GIF animation is documented as a repository artifact but is not embedded in the PDF, because standard PDF output does not reliably support animated playback.
